...
export class RunStore{
  ...
  get(runId){const file=this.file(runId);if(!fs.existsSync(file))throw Object.assign(new Error('RUN_NOT_FOUND'),{code:'RUN_NOT_FOUND'});return JSON.parse(fs.readFileSync(file,'utf8'))}
