...
export class ChangesetStore{
 ...
 get(id){const f=this.file(id);if(!fs.existsSync(f))throw new Error('CHANGESET_NOT_FOUND');const doc=JSON.parse(fs.readFileSync(f,'utf8'));if(doc?.id!==id)throw new Error('CHANGESET_ID_MISMATCH');return doc}
