...
function validAuthorityReceipt(receipt){
  ...
  if(receipt.context!==null&&receipt.policyDigest===null)return false;
  if(receipt.materializedDigest!==null&&(receipt.context===null||receipt.policyDigest===null))return false;
